...
// void get_momentum_distribution(float momentum_distribution[], int num_buckets, Particle current_particles[], int num_particles);
...
// float get_total_momentum(Particle current_particles[], int num_particles);
...
// float get_max_momentum(Particle current_particles[], int num_particles);
...
// float get_min_momentum(Particle current_particles[], int num_particles);